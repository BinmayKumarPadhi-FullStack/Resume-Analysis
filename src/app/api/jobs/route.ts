...
export async function GET(req: NextRequest) {
  try {
    ...
    const api_url = `https://api.adzuna.com/v1/api/jobs/${country}/search/${page}?app_id=${ADZUNA_APP_ID}&app_key=${ADZUNA_API_KEY}&results_per_page=${jobsPerPage}&what=${skills}&content-type=application/json`;
